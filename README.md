...
**Work in progress.** Restructure landed; later phases add the `super_lib` Python helpers, the 8 top-level `super-*` skills, the polyglot session-start hook, and the `super-model-setup.py` install script. Target version: `v2.0.0`.
