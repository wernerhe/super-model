"""super-delete-branch: manifest <-> module files <-> presets consistency."""
...
def test_module_count_matches_canonical(super_root: Path) -> None:
    """super-delete-branch has 4 modules: branch-info-collect,
    uniqueness-check, value-check, delete-confirm."""
