"""super-prepare-branch: manifest <-> module files <-> presets consistency."""
...
def test_module_count_matches_canonical(super_root: Path) -> None:
    """super-prepare-branch has 4 modules: review-cache-check,
    commit-hygiene, rebase-preview, push-readiness."""
