...
def test_module_count_matches_canonical(super_root: Path) -> None:
    """super-visual-debug has 6 modules: capability-probe,
    initial-capture, fix-proposal, apply-and-recapture,
    compare-iterations, capability-memory."""
