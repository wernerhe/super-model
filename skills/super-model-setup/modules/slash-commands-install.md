...
- `<project>/.claude/commands/super-model-setup.md`
...
Claude Code, Windsurf, and Cline are the three major agentic IDEs the user wants Super-Model to feel native in. A single `super-model-setup` run wires all three so the user does not have to think about which IDE they happen to be using.
